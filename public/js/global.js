...
function initialize() {
  var mapOptions = {
    zoom: 14,
    center: new google.maps.LatLng(36.8684, 10.2489), // Remplacez les coordonnées ici
    scrollwheel: false,
    draggable: false
  };
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const menuItemBg = document.querySelector('.menu-item-bg');
  const dropdown = document.querySelector('.dropdown');

  menuLink.addEventListener('click', function(e) {
      e.preventDefault();
      menuItemBg.classList.toggle('active');
